...
<body>
    <div class="container" style="max-width: 600px;">
        ...
        <div style="padding: 40px;">
            ...
            <p style="color: #555; margin-bottom: 25px;"><?= htmlspecialchars($musicaAtual['artista']) ?></p>
            ...
            <form action="salvar_avaliacao.php" method="POST">
                ...
                <select name="nota" id="nota" required style="width: 100%; padding: 14px; font-size: 16px; border-radius: 10px; margin: 10px 0;">
                    ...
                    <option value="3">⭐⭐⭐ Nota 3 - Regular</option>
                    <option value="4">⭐⭐⭐⭐ Nota 4 - Boa</option>
                    <option value="5">⭐⭐⭐⭐⭐ Nota 5 - Excelente</option>
                </select>

                <label><strong>Sua avaliação:</strong></label>
                <textarea name="comentario" placeholder="Escreva sua opinião sobre a música..." rows="6" required></textarea>

                <div style="margin-top: 30px; display: flex; gap: 15px;">
                    <button type="submit" style="flex: 1;">Postar Avaliação</button>
                    <a href="index.php" style="flex: 1; text-decoration: none;">
                        <button type="button" style="background: #666; width: 100%;">Cancelar</button>
                    </a>
                </div>
            </form>
        </div>
